...
grails.project.groupId = 'mx.com.pumc' // change this to alter the default package name and Maven publishing destination
...
log4j = {
    ...
    //
    def logLayoutPattern = new PatternLayout('%-8r %d{dd/MM/yyyy HH:mm:ss} [%25.25t] %-5p %c{1} - %m%n')
